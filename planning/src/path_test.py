...
def pick_and_place(pt1, pt2, q0, q1):
    """
...
def pick_and_place_server():
    ...
    s = rospy.Service('pick_and_place', PlacePieceRequest, handle_pick_and_place)
    rospy.spin()
